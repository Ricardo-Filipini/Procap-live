    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Configurações do Agente IA (Ed)">
            <div className="space-y-4 text-sm">
                <div>
                    <label className="block font-medium mb-1">Sua Chave de API Gemini (Opcional)</label>
                    <input
                        type="password"
                    ...
                    />
                    <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-500 hover:underline mt-1 flex items-center gap-1">
